...
public:
    ...
    mapOptimization()
    {
        ...
        pubRecentKeyFrame     = nh.advertise<liorf::cloud_pos>("liorf/mapping/cloud_registered", 1);
...
/*             float arx = (crx*sry*srz*pointOri.x + crx*crz*sry*pointOri.y - srx*sry*pointOri.z) * coeff.x
    ...
    void publishFrames()
    {
        ...
        if (pubRecentKeyFrame.getNumSubscribers() != 0)
        {
            ...
            publishCloud_pose(pubRecentKeyFrame, laserCloudSurfLastDS, timeLaserInfoStamp, odometryFrame,transformTobeMapped);
        }
